...
<?php 
    ...
    $event_extended_date = date('d M Y', $post_meta['_tfIpf_event_date'][0]);
...
<div id="primary">
    <div id="content" class="site-content TFIP-style <?php echo $post_meta['_tfIpf_event_type'][0] ?>" role="main">
                        ...
                        ?>
                            <div class="dett-music row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <h4><?php echo $post_meta['_tfIpf_event_time'][0]?></h4><hr>
                ...
                <div class="row">
                    ...
                    if($post_meta['_tfIpf_event_type'][0] == "sport")
                    {
                        ...
                        <div class="descrizione-sport">
                            ...
                            <b><?php echo $post_meta['_tfip_exact_time_event'][0] ?> </b> 
                            in fascia oraria: 
                            <b><?php echo $post_meta['_tfIpf_event_time'][0] ?> </b> 
...
<script>
    ...
    addEventListener("DOMContentLoaded", (event) => {
        ...
        LoadBaseClientBookingForm( 
            <?php echo $post_id ?>, 
            <?php echo get_post_meta($post_id, '_tfIpf_event_timeslot', true); ?>,
            <?php echo $post_meta['_tfIpf_event_date'][0]; ?>,
            null
        )
